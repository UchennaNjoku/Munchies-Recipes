      ...
      <div className="flex w-screen h-24 justify-between p-0 m-0 bg-white"> 
        ...
        <form class="flex max-w-2xl grow items-center" onSubmit={submitHandler}>
          <div class="relative w-full">
            <input type="text" onChange= {(e) => setInput(e.target.value)} value={input} class=" h-9 grow bg-search-gray border border-gray-300 text-white font-poppins text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-300 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
        ...
        <div className='flex md:hidden mr-5 ml-5 text-xl p-0 justify-center items-center'>
          <div class="dropdown dropdown-end relative">
            ...
            <ul tabindex="0" class="dropdown-content top-10 absolute menu p-2 shadow bg-base-100 rounded-box w-40">
  ...
  return (
    <div>
      <div className="md-flex">
          <ul className='flex font-normal justify-center items-center '>
